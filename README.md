...
**版本** `v1.1.18` ｜ **平台** Linux / macOS / Windows ｜ **语言** 中文 ｜ **License** MIT
...
curl -X POST \
  ...
  "https://YOUR_CPA_HOST/v0/management/plugin-store/grok-panel/install?source=YOUR_SOURCE_ID&version=v1.1.18"
```
...
```text
grok-panel_1.1.18_linux_amd64.zip
grok-panel_1.1.18_linux_arm64.zip
grok-panel_1.1.18_darwin_amd64.zip
grok-panel_1.1.18_darwin_arm64.zip
grok-panel_1.1.18_windows_amd64.zip
grok-panel_1.1.18_windows_arm64.zip
```

解压后将插件库文件放入 CPA 配置的插件目录：

```text
plugins/linux/amd64/grok-panel-v1.1.18.so
plugins/linux/arm64/grok-panel-v1.1.18.so
plugins/darwin/amd64/grok-panel-v1.1.18.dylib
plugins/darwin/arm64/grok-panel-v1.1.18.dylib
plugins/windows/amd64/grok-panel-v1.1.18.dll
plugins/windows/arm64/grok-panel-v1.1.18.dll
```
